...
export class PixIcon extends Atom<{ prop: IProp, sub: ISub }> {

    preRender: () => void = ()=>{
        if(!this.prop.color) this.prop.color = "#4BB8A9"
    }
    struct = () => (
        <div>
            <Icon width={this.prop.width} height={this.prop.height} color={this.prop.color}
                ...
                <svg viewBox="0 0 512 512" xmlns="http://www.w3.org/2000/svg">
                    <defs />
                    <g sub={this.sub.g} fill-rule="evenodd">
    ...
    setColor = (color: string) => {
        this.sub.g.setAttribute("fill", color)
    }
}