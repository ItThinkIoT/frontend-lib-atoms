/* Symbols list extracted from: https://fonts.google.com/icons?icon.set=Material+Symbols
```js - F12 Console:
let symbols = []
for(const el of document.getElementsByTagName("gf-load-icon-font")) {symbols.push(el.textContent)}
```
*/
